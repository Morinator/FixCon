...
fun main(args: Array<String>) {
    ...
    try {
        ...
        File("results/$graphName.$k.$funcID.fixcon").writeText(funcID.toString().padStart(5) + graphName.padStart(40) + vertexCount.toString().padStart(7) + edgeCount.toString().padStart(9) + k.toString().padStart(4) + secondsElapsed.toString().padStart(9) + result.value.toString().padStart(6) + "\n")
