...
final public class Factory {
     ...
     */
    public static UndirectedGraph createClique(int size) {
     ...
     */
    public static UndirectedGraph createCircle(int size) {
     ...
     */
    public static UndirectedGraph createPath(int size) {
     ...
     */
    public static UndirectedGraph createStar(int size) {
