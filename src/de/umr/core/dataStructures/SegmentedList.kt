...
class SegmentedList<T> {
    ...
    /**entry at index *i* contains how many elements are stored in the segments 0,1,...,i-1,i*/
    ...
    fun addToLast(col: Collection<T>) { //TODO Test
    ...
    fun removeLastSegment() {
        repeat(segmentSizes.last() - (segmentSizes.getOrNull(segmentSizes.size - 2) ?: 0)) {
